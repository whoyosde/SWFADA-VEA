...
public class MyPage extends PageObject {
    ...
    @FindBy(xpath = "//p[contains(text(),'CONTINUAR BORRADOR')]")
    private WebElementFacade btnContinuar;

    @FindBy(xpath = "//p[contains(text(),'Lista de borradores')]")
    private WebElementFacade opcionLista;
    ...
    public void accederAlProcedimiento() {
        WebDriverWait wait = new WebDriverWait(getDriver(), 30);
    ...
    public void seleccionarListaDeBorradores() {
        WebDriverWait wait = new WebDriverWait(getDriver(),80);
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[contains(text(),'Lista de borradores')]")));
        opcionLista.click();
    }
