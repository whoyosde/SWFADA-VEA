package org.swfada.PF042.stepdefinition;

import io.cucumber.java.es.Cuando;
import io.cucumber.java.es.Entonces;
import io.cucumber.java.es.Y;
import net.thucydides.core.annotations.Steps;
import org.swfada.PF042.step.MyStep;
...
public class MyStepdefinition {
    ...
    @Y("PF042 - se cumplimenta los campos obligatorios: {string}, {string}, {string}, {string}")
    ...
    @Y("PF042 - se cumplimenta los campos obligatorios del documento opcional: {string}, {string}, {string}, {string}, {string}")
