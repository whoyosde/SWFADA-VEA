package org.swfada.PF044.step;

import net.thucydides.core.steps.ScenarioSteps;
import org.swfada.PF044.page.MyPage;
...
public class MyStep extends ScenarioSteps {
    ...
    public void sePulsaSobreElIconoEliminarDelDocumentoObligatorio() {
        myPage.pulsarIconoEliminarDocumentoObligatorio();
    }

    @net.thucydides.core.annotations.Step
    public void sePulsaSobreElBotónEliminar() {
        myPage.pulsarBotónEliminar();
    }
    ...
    public void seValidaQueLaAutorizaciónNoSeElimineDelExpediente() {
        myPage.validarDocumentoAutorización();
    }
}
